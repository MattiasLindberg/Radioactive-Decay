...
#bg1 = DataFile(".\MEJ-background-lang serie.lst", 0.5)
#bg1.LoadValues(10, 1020)
#bg1.MergeBuckets(10)
#bg1.PlotWithPoisson()

print("Loading data for background noise")
bg2 = BackgroundData(".\MEJ-background-serie-2-5-sek.lst", 5)
bg2.LoadValues(10, 122)
#bg2.PlotWithPoisson("Distribution of background noice")

#print("Loading data for background noise")
#bg3 = DataFile(".\MEJ-background-serie-3-5-sek.lst", 5)
...
ag1 = DecayData(".\MEJ-seilver-10 min-serie 2-5 sek.lst", 5)
